...
verus! {
    ...
    //proof
    pub proof fn container_subtree_inv(root_container:ContainerPtr, container_perms:Map<ContainerPtr, PointsTo<Container>>)
        requires
            container_perms_wf(container_perms),
    ...
    pub proof fn same_or_deeper_depth_imply_none_ancestor(root_container:ContainerPtr, container_perms:Map<ContainerPtr, PointsTo<Container>>, a_ptr:ContainerPtr, child_ptr:ContainerPtr)
        requires
            container_perms_wf(container_perms),
            container_tree_wf(root_container, container_perms),
    ...
    pub proof fn no_child_imply_no_subtree(root_container:ContainerPtr, container_perms:Map<ContainerPtr, PointsTo<Container>>, c_ptr:ContainerPtr)
        requires
            container_perms_wf(container_perms),
            container_tree_wf(root_container, container_perms),
            container_perms.dom().contains(c_ptr),
    ...
    pub proof fn in_child_impy_in_subtree(root_container:ContainerPtr, container_perms:Map<ContainerPtr, PointsTo<Container>>, c_ptr:ContainerPtr, child_ptr:ContainerPtr, s_ptr:ContainerPtr)
        requires
            container_perms_wf(container_perms),
            container_tree_wf(root_container, container_perms),
            container_perms.dom().contains(c_ptr),
    ...
    pub proof fn in_subtree_imply_exist_in_child(root_container:ContainerPtr, container_perms:Map<ContainerPtr, PointsTo<Container>>, c_ptr:ContainerPtr, s_ptr:ContainerPtr)
        requires
            container_perms_wf(container_perms),
            container_tree_wf(root_container, container_perms),
            container_perms.dom().contains(c_ptr),
    ...
    pub proof fn not_in_dom_imply_not_in_any_children_set(root_container:ContainerPtr, container_perms:Map<ContainerPtr, PointsTo<Container>>, s_ptr:ContainerPtr)
        requires
            container_perms_wf(container_perms),
            container_tree_wf(root_container, container_perms),
    ...
    pub proof fn container_tree_wf_imply_uppertree_subset_of_tree(root_container:ContainerPtr, container_perms:Map<ContainerPtr, PointsTo<Container>>)
        requires
            container_perms_wf(container_perms),
            container_tree_wf(root_container, container_perms),
        ensures
            forall|c_ptr:ContainerPtr, parent_c_ptr:ContainerPtr|
                #![auto]
                container_perms.dom().contains(c_ptr) && container_perms[c_ptr].value().uppertree_seq@.contains(parent_c_ptr)
                ==>
                container_perms.dom().contains(parent_c_ptr),
    {
    }

    pub proof fn container_tree_wf_imply_childern_uppertree_specs(root_container:ContainerPtr, container_perms:Map<ContainerPtr, PointsTo<Container>>)
        requires
            container_perms_wf(container_perms),
            container_tree_wf(root_container, container_perms),
        ensures
    ...
    pub proof fn container_tree_inv(root_container:ContainerPtr, container_perms:Map<ContainerPtr, PointsTo<Container>>)
        requires
            container_perms_wf(container_perms),
            container_tree_wf(root_container, container_perms),
        ensures
    ...
    pub proof fn container_subtree_disjoint_inv(root_container:ContainerPtr, container_perms:Map<ContainerPtr, PointsTo<Container>>)
        requires
            container_perms_wf(container_perms),
            container_tree_wf(root_container, container_perms),
        ensures
    ...
    pub proof fn container_no_change_to_tree_fields_imply_wf(root_container:ContainerPtr, old_container_perms:Map<ContainerPtr, PointsTo<Container>>,  new_container_perms:Map<ContainerPtr, PointsTo<Container>>)
        requires
    ...
    pub open spec fn new_container_tree_ensures(root_container:ContainerPtr, new_container_perms:Map<ContainerPtr, PointsTo<Container>>, 
        new_container_ptr:ContainerPtr) -> bool
    {
        &&&
    ...
    pub proof fn new_container_tree_infer_wf(root_container:ContainerPtr, new_container_perms:Map<ContainerPtr, PointsTo<Container>>, 
    ...
    pub open spec fn new_container_ensures(root_container:ContainerPtr, old_container_perms:Map<ContainerPtr, PointsTo<Container>>,  new_container_perms:Map<ContainerPtr, PointsTo<Container>>, 
    ...
    pub proof fn new_container_preserve_tree_inv(root_container:ContainerPtr, old_container_perms:Map<ContainerPtr, PointsTo<Container>>,  new_container_perms:Map<ContainerPtr, PointsTo<Container>>, 
    ...
    pub proof fn new_container_preserve_tree_inv_1(root_container:ContainerPtr, old_container_perms:Map<ContainerPtr, PointsTo<Container>>,  new_container_perms:Map<ContainerPtr, PointsTo<Container>>, 
        container_ptr:ContainerPtr, new_container_ptr:ContainerPtr)
        requires
            new_container_ensures(root_container, old_container_perms, new_container_perms, container_ptr, new_container_ptr),
        ensures
    ...
    pub proof fn new_container_preserve_tree_inv_2(root_container:ContainerPtr, old_container_perms:Map<ContainerPtr, PointsTo<Container>>,  new_container_perms:Map<ContainerPtr, PointsTo<Container>>, 
        container_ptr:ContainerPtr, new_container_ptr:ContainerPtr)
        requires
            new_container_ensures(root_container, old_container_perms, new_container_perms, container_ptr, new_container_ptr),
        ensures
    ...
    pub proof fn new_container_preserve_tree_inv_3(root_container:ContainerPtr, old_container_perms:Map<ContainerPtr, PointsTo<Container>>,  new_container_perms:Map<ContainerPtr, PointsTo<Container>>, 
        container_ptr:ContainerPtr, new_container_ptr:ContainerPtr)
        requires
            new_container_ensures(root_container, old_container_perms, new_container_perms, container_ptr, new_container_ptr),
        ensures
    ...
    pub proof fn new_container_preserve_tree_inv_4(root_container:ContainerPtr, old_container_perms:Map<ContainerPtr, PointsTo<Container>>,  new_container_perms:Map<ContainerPtr, PointsTo<Container>>, 
        container_ptr:ContainerPtr, new_container_ptr:ContainerPtr)
        requires
            new_container_ensures(root_container, old_container_perms, new_container_perms, container_ptr, new_container_ptr),
        ensures
    ...
    pub proof fn new_container_preserve_tree_inv_5(root_container:ContainerPtr, old_container_perms:Map<ContainerPtr, PointsTo<Container>>,  new_container_perms:Map<ContainerPtr, PointsTo<Container>>, 
        container_ptr:ContainerPtr, new_container_ptr:ContainerPtr)
        requires
            new_container_ensures(root_container, old_container_perms, new_container_perms, container_ptr, new_container_ptr),
        ensures
    ...
    pub proof fn new_container_preserve_tree_inv_6(root_container:ContainerPtr, old_container_perms:Map<ContainerPtr, PointsTo<Container>>,  new_container_perms:Map<ContainerPtr, PointsTo<Container>>, 
        container_ptr:ContainerPtr, new_container_ptr:ContainerPtr)
        requires
            new_container_ensures(root_container, old_container_perms, new_container_perms, container_ptr, new_container_ptr),
        ensures
    ...
    pub proof fn new_container_preserve_tree_inv_7(root_container:ContainerPtr, old_container_perms:Map<ContainerPtr, PointsTo<Container>>,  new_container_perms:Map<ContainerPtr, PointsTo<Container>>, 
        container_ptr:ContainerPtr, new_container_ptr:ContainerPtr)
        requires
            new_container_ensures(root_container, old_container_perms, new_container_perms, container_ptr, new_container_ptr),
        ensures
