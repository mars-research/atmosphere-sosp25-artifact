...
verus! {
    ...
    pub closed spec fn proc_tree_dom_subset_of_proc_dom(proc_tree_dom:Set<ProcPtr>, proc_perms:Map<ProcPtr, PointsTo<Process>>) -> bool{
        &&&
        forall|p_ptr:ProcPtr| 
        ...
        proc_ptr:ProcPtr, new_proc_ptr:ProcPtr) -> bool
    {
        ...
        &&&
        old_proc_perms[proc_ptr].value().children.len() < CONTAINER_CHILD_LIST_LEN
        &&&
        ...
        forall|p_ptr:ProcPtr| 
            ...
            new_proc_perms.dom().contains(p_ptr) && p_ptr != proc_ptr
            ==>               
        ...
        forall|p_ptr:ProcPtr| 
            ...
            new_proc_perms.dom().contains(p_ptr) && new_proc_perms[new_proc_ptr].value().uppertree_seq@.contains(p_ptr)
            ==>
        ...
        forall|p_ptr:ProcPtr| 
            ...
            #![trigger new_proc_perms[p_ptr].value().subtree_set] 
            new_proc_perms.dom().contains(p_ptr) && new_proc_perms[new_proc_ptr].value().uppertree_seq@.contains(p_ptr) == false
            ==>
