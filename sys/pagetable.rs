...
#[verifier(external_body)]
pub proof fn lemma_1(va: usize)
    ensures
        forall|va_1:usize, va_2:usize| #![auto] va_1 == va_2 ==> (
...
// pub proof fn lemma_1(va: usize)
//     requires va & 0xfff == 0,
//     ensures index2va(va2index(va)) == va,
// {
// }
...
//         forall|va: usize| #![auto]  self.mapping@.dom().contains(va) ==> self.mapping@[va] == self.resolve_mapping_l1(v2l4index(va),v2l3index(va),v2l2index(va),v2l1index(va))
...
//         // proof {
//         //     let va = 
//         //     self.mapping@ = self.mapping@.insert((l4i,l3i,l2i,l1i),dst);}
//         // assert(self.mapping@[(l4i,l3i,l2i,l1i)]==dst);
...
//         // assert(forall|va:usize| #![auto] (0<= _l4i < 512 && 0<= _l3i < 512 && 0<= _l2i < 512 && 0<= _l1i < 512) && !((_l4i,_l3i,_l2i,_l1i) =~= (l4i,l3i,l2i,l1i))==> 
...
//         // assert(forall|_l4i: usize,_l3i: usize,_l2i: usize,_l1i: usize| #![auto] 0<= _l4i < 512 && 0<= _l3i < 512 && 0<= _l2i < 512  && 0<= _l1i < 512  && self.resolve_mapping_l2(_l4i,_l3i,_l2i) != l1_ptr ==> (
//         //     self.resolve_mapping_l1(_l4i,_l3i,_l2i,_l1i) == self.mapping@[(_l4i,_l3i,_l2i,_l1i)])
//         // );
